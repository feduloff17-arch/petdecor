...
const translations = {
  ru: {
    ...
    "slateKennel.desc": "Логотип питомника, переведенный в материал. Черный сланец и шлифованная сталь превращают фирменный знак в предмет, который хочется вешать на стену, а не убирать в папку. Работает как настенный акцент или как настольный объект рядом с наградами. Натуральный черный сланец, шлифованная нержавеющая сталь. 30 x 20 см, настенное или настольное размещение.",
    "silverLabradorClock.type": "Clock",
    "silverLabradorClock.desc": "Серебристый акрил, темный циферблат, лабрадор с бабочкой - часы, которые не кричат о себе, но их замечаешь. Сдержанный холодный акцент: хорошо на кухне, в кабинете, в современном интерьере без лишних деталей. Серебряный акрил, стеклянный фасад. Диаметр 27 см.",
    "forgedLabradorBracket.type": "Кронштейн",
    "forgedLabradorBracket.desc": "Кронштейн для питомника, входной зоны или сада - силуэт лабрадора, кованая консоль и подвесная табличка с именем. Смотрится как элемент, который был задуман для этого места, а не повешен потом. Размер 50 см, металл держит форму на улице. Металл 2 мм, профильная труба 15 мм, кованый декоративный элемент. Длина кронштейна 50 см.",
    "ringNumberHolder.type": "Держатель номера",
    "ringNumberHolder.desc": "Небольшой, но заметный. Держатель рингового номера из эпоксидной смолы с глиттерной заливкой - каждый экземпляр получает свой рисунок. Легкий, надежно держит номер, добавляет образу чуть больше характера прямо в ринге. Эпоксидная смола, декоративная проволока. Полностью ручная работа.",
    "goldRingNumberHolder.type": "Держатель номера",
    "goldRingNumberHolder.desc": "Держатель номера, который заметят до того, как объявят результат. Золотая поталь, глиттер и эпоксидная смола - каждый сделан руками, каждый немного отличается. Носится как украшение, работает как аксессуар ринга. Декоративная проволока, золотая поталь, глиттер, эпоксидная смола. Ручная работа.",
    "monoBreedAwards.type": "Призы",
    "monoBreedAwards.desc": "Серия наград для монопородной выставки: BOB, BOS, WB, WD. Основа из полированной маслины - теплое дерево с характерной текстурой. Стальные и латунные элементы отполированы по-разному, так что фактуры не сливаются - каждый приз читается отдельно и вместе. Цена от 75 EUR за штуку, серия из 4 - от 250 EUR. Полированная маслина, нержавеющая сталь 2 мм, латунь 2 мм.",
    "labradorExpertPlates.type": "Призы",
    "labradorExpertPlates.desc": "BOB, BOS, Best Junior - три тарелки, три момента, которые стоит запомнить. Анодированное покрытие с хромированным эффектом, прозрачная подставка, гравировка под заказ. Приз, который смотрится на полке так же сильно, как в момент вручения. Металл, анодированное покрытие с эффектом хромирования, прозрачная подставка. Диаметр 27 см.",
    "huskySlateAward.type": "Настенный приз",
    "huskySlateAward.desc": "Награда, которая не пылится в шкафу. Натуральный черный сланец и нержавеющая сталь держат форму десятилетиями - и именно так выглядит, будто была здесь всегда. Портрет хаски с северными мотивами гравируется с обеих сторон: лицевая - для зала, обратная - для личной подписи или посвящения. Срок изготовления 2-3 недели. Натуральный черный сланец, нержавеющая сталь 2 мм. Диаметр 30 см, двусторонняя гравировка.",
    "goldenRetrieverClock.type": "Clock",
    "goldenRetrieverClock.desc": "Голден наблюдает за бабочкой - золотой силуэт на темном циферблате. Теплый акцент для комнаты, где не хочется лишнего. Смотрится в гостиной, спальне, в любом спокойном интерьере. Золотой акрил, стеклянный фасад. Диаметр 27 см.",
    "goldClock.type": "Clock",
    "goldClock.desc": "Щенок лабрадора на темном циферблате - тихий, но заметный акцент. Золотой акрил не кричит и не теряется: работает там, где нужна теплота без декоративного шума. Золотой акрил, стеклянный фасад. Диаметр 27 см.",
    "addressPlate.type": "Address sign",
    "addressPlate.desc": "Табличка с номером дома - и сразу понятно, что здесь живут с собакой. Силуэт лабрадора, декоративная листва, шоколадная патина с ручной обработкой. Смотрится на фасаде как деталь, которая была задумана с самого начала. Металл 2 мм, шоколадная порошковая краска, ручное патинирование.",
    "blackChocolateSign.type": "Вывеска с подсветкой",
    "blackChocolateSign.desc": "Вывеска, которая работает круглосуточно. Днем - выразительный фасадный объект с силуэтами лабрадоров, ночью - теплый контурный свет. Кронштейн для кашпо вписан в композицию, не добавлен сбоку. Делается под конкретный питомник - с именем и деталями. Металл 2 мм, порошковая покраска, контурная LED-подсветка теплого свечения. 1 x 1,7 м.",
    "bellaMarePanel.type": "Подарочное панно",
    "bellaMarePanel.desc": "Панно для питомника Bella Mare: теплая фактура ясеня, имя питомника и стальные элементы собраны в одну чистую композицию. Перламутровый глиттер под смолой дает мягкий блеск - не бросается в глаза, но виден вблизи. Подойдет как подарок для мастерской или зала приемов. Ясень, нержавеющая сталь, перламутровый глиттер, эпоксидная смола. 50 x 30 см.",
    "panel.type": "Wall panel",
    "panel.desc": "Вертикальный акцент для стены, которой не хватает одной детали. Черный силуэт - собака, камыши, летящая птица - на теплой деревянной основе. Компактно, читается сразу, подходит для прихожей, кабинета или гостиной. Дерево, металлический силуэт. 17 x 42 см.",
    "bracket.type": "Kennel sign",
    "bracket.desc": "Кронштейн с силуэтом борзой и подвесной табличкой Radiance Soul в бронзовой патине. Для входной зоны питомника или вольера - узнаваемый акцент, который видно с дороги и интересно рассматривать вблизи. Металл 2 мм, порошковая покраска, ручное патинирование.",
    "box.type": "Gift set",
    "box.desc": "Два стакана с лазерной гравировкой, уложенные в деревянную шкатулку - подарок, который не нужно объяснять. Открываешь - и все понятно. Шкатулка из фанеры с фурнитурой под старую латунь, стаканы гравируются под заказ. Фанера 6 мм, лазерная гравировка, фурнитура под латунь.",
    "birchHuntingMoneyBox.type": "Купюрница",
    "birchHuntingMoneyBox.desc": "Шкатулка из березы с охотничьей сценой - это не просто место для денег или украшений. Это вещь, которую хочется поставить на стол и рассматривать. Лабрадор в стойке, лазерная гравировка с глубиной, фурнитура под антикварную бронзу - все вместе держит характер охотничьего стиля без лишнего. Хороший подарок для тех, кто ценит детали. Береза, лазерная гравировка, фурнитура под бронзу. 190 x 105 x 65 мм.",
    "keyholder.type": "Key holder shelf",
    "keyholder.desc": "Ключница с характером для прихожей. Силуэт охотника с собакой на деревянной полке с черными боковинами и крючками - для ключей, поводков, обувной ложки. 25 см, и входная зона сразу становится теплее. Дерево, металл с порошковым покрытием. 25 см.",
    "leashShelf.type": "Leash shelf",
    "leashShelf.desc": "Практичная вещь, которая выглядит не практично, а хорошо. Черные силуэты собак, крючки, место для поводков - все на полированной брашированной сосне, обработанной маслом-воском. Каждый день берешь поводок и видишь что-то свое. Брашированная и полированная сосна, масло-воск, металлические крючки. 27 см.",
    "bathShelfHanger.type": "Вешалка с полкой",
    "bathShelfHanger.desc": "Выходишь из парной - и это первое, что видишь. Черный патинированный металл, брашированная сосна, маленькие стальные фигурки в клубах пара. Полка держит аксессуары, а сама по себе - украшение бани или сауны, которое не требует ничего вокруг. Патинированный металл, брашированная и полированная сосна, декоративная композиция из нержавеющей стали.",
    "cosmicCatHanger.type": "Мини-вешалка",
    "cosmicCatHanger.desc": "Кошка в космосе у входной двери. Металлическая основа, несколько слоев эпоксидной смолы с глиттерным эффектом галактики, латунные детали. Каждое изделие заливается отдельно - рисунок всегда немного свой. Держит ключи, поводок, аксессуары. Металл, многослойная эпоксидная смола, латунные элементы. Около 20 см, каждое изделие уникально.",
    ...
    "roundHuntPanel.desc": "Охотничья сцена - лабрадор и утка - в теплой фактуре акации под прозрачной смолой. Латунь и нержавеющая сталь в одной композиции дают контраст без напряжения. Круглое, компактное, хорошо смотрится отдельно или в паре с другим панно. Акация, латунь, нержавеющая сталь, эпоксидная смола. Диаметр 19 см.",
  ...
  ua: {
    ...
    "slateKennel.type": "Decorative plaque",
    "slateKennel.desc": "Образ: інтер'єрна версія логотипа розплідника з глибоким чорним сланцем і холодним блиском сталі. Матеріали: натуральний чорний сланець і шліфована нержавіюча сталь. Розмір і деталі: 30 x 20 см, настінне або настільне розміщення.",
    "silverLabradorClock.type": "Clock",
    "silverLabradorClock.desc": "Образ: лабрадор і метелик створюють спокійний холодний акцент для кухні, кабінету або сучасного інтер'єру. Матеріали: срібний акрил на темному циферблаті, скло у фасаді. Розмір і деталі: діаметр 27 см, настінне розміщення.",
    "forgedLabradorBracket.type": "Кронштейн",
    "forgedLabradorBracket.desc": "Образ: виразний фасадний акцент із силуетом лабрадора, підвісною табличкою та декоративною консоллю. Матеріали: метал, профільна труба і кований декоративний елемент. Розмір і деталі: кронштейн 50 см, метал 2 мм, профільна труба 15 мм.",
    "ringNumberHolder.type": "Тримач номера",
    "ringNumberHolder.desc": "Образ: легкий виставковий аксесуар із силуетом собаки та живим блиском смоли. Матеріали: епоксидна смола, декоративний дріт і металевий затискач. Розмір і деталі: ручна робота, кожен виріб має унікальний рисунок заливки.",
    "goldRingNumberHolder.type": "Тримач номера",
    "goldRingNumberHolder.desc": "Образ: ринговий аксесуар із виразним контуром, золотим блиском і прозорою глибиною смоли. Матеріали: декоративний дріт, глітер, золота поталь і епоксидна смола. Розмір і деталі: ручна робота, форма і рисунок заливки індивідуальні.",
    "monoBreedAwards.type": "Призи",
    "monoBreedAwards.desc": "Образ: серія виставкових призів із силуетами собак, птахами та титулами BOB, BOS, WB і WD. Матеріали: полірована маслина, нержавіюча сталь і латунь із різною фактурою. Розмір і деталі: сталь 2 мм, латунь 2 мм, ціна від 75 EUR за штуку, від 250 EUR серія з 4 штук.",
    "labradorExpertPlates.type": "Призи",
    "labradorExpertPlates.desc": "Образ: експертні призи для монопородної виставки лабрадорів із персональними титулами BOB, BOS і Best Junior. Матеріали: декоративні тарілки з анодованим покриттям і прозора підставка. Розмір і деталі: діаметр тарілки 27 см, покриття з ефектом хромування.",
    "huskySlateAward.type": "Настінний приз",
    "huskySlateAward.desc": "Образ: інтер'єрний приз із портретом хаскі, північними мотивами та персональним написом на звороті. Матеріали: натуральний чорний сланець і нержавіюча сталь. Розмір і деталі: діаметр 30 см, сталь 2 мм, двостороннє гравіювання, виготовлення 2-3 тижні.",
    "goldenRetrieverClock.type": "Clock",
    "goldenRetrieverClock.desc": "Образ: голден ретривер, що спостерігає за метеликом, створює теплий акцент для спокійного інтер'єру. Матеріали: золотий акрил на темному циферблаті, скло у фасаді. Розмір і деталі: діаметр 27 см, настінний годинник.",
    "goldClock.type": "Clock",
    "goldClock.desc": "Образ: цуценя лабрадора на темному циферблаті додає інтер'єру м'який золотий акцент. Матеріали: золотий акрил і скляний фасад. Розмір і деталі: діаметр 27 см, настінний годинник.",
    "addressPlate.type": "Address sign",
    "addressPlate.desc": "Образ: адресна табличка із силуетом лабрадора, декоративним листям і номером будинку в теплій шоколадній патині. Матеріали: метал із порошковим покриттям і ручним патинуванням. Розмір і деталі: метал 2 мм, фасадне розміщення.",
    "blackChocolateSign.type": "Вивіска з підсвічуванням",
    "blackChocolateSign.desc": "Образ: фасадна вивіска розплідника, де назва, силуети лабрадорів і тепле контурне світіння працюють як єдиний знак. Матеріали: метал, порошкове фарбування і LED-підсвічування. Розмір і деталі: метал 2 мм, тепле бек LED-підсвічування, розмір 1 x 1,7 м.",
    "bellaMarePanel.type": "Подарункове панно",
    "bellaMarePanel.desc": "Образ: подарункове панно для розплідника Bella Mare з чистою інтер'єрною композицією та м'яким перламутровим блиском. Матеріали: ясен, нержавіюча сталь, глітер і прозора епоксидна смола. Розмір і деталі: 50 x 30 см, основа з ясеня, декор із нержавіючої сталі.",
    "panel.type": "Wall panel",
    "panel.desc": "Образ: компактний вертикальний акцент із собакою, очеретом і птахом у польоті для вітальні, передпокою або кабінету. Матеріали: тепла дерев'яна основа і чорний декоративний силует. Розмір і деталі: декоративне панно 17 x 42 см.",
    "bracket.type": "Kennel sign",
    "bracket.desc": "Образ: вхідний акцент із силуетом російської борзої та підвісною табличкою Radiance Soul у теплій бронзовій патині. Матеріали: метал із порошковим покриттям і ручним патинуванням. Розмір і деталі: кронштейн із декоративною консоллю, метал 2 мм.",
    "box.type": "Gift set",
    "box.desc": "Образ: камерний подарунковий набір для дому або кабінету з двома гравійованими склянками всередині скриньки. Матеріали: фанера, лазерне гравіювання і фурнітура під стару латунь. Розмір і деталі: скринька з фанери 6 мм.",
    "birchHuntingMoneyBox.type": "Купюрниця",
    "birchHuntingMoneyBox.desc": "Образ: купюрниця з лабрадором у мисливському сюжеті, глибоким благородним відтінком і подарунковим характером. Матеріали: натуральна береза, лазерне гравіювання і замок під античну бронзу. Розмір і деталі: 190 x 105 x 65 мм, для купюр і біжутерії.",
    "keyholder.type": "Key holder shelf",
    "keyholder.desc": "Образ: силует мисливця із собакою робить вхідну зону теплішою і додає предмету характер. Матеріали: дерев'яна полиця, чорні декоративні боковини і металеві гачки. Розмір і деталі: ключниця-вішалка 25 см, для ключів, повідців і ложки для взуття.",
    "leashShelf.type": "Leash shelf",
    "leashShelf.desc": "Образ: акуратний акцент для передпокою із силуетами собак, гачками і місцем для повідців. Матеріали: полірована і брашована сосна, чорний декор і олія-віск. Розмір і деталі: полиця-ключниця 27 см.",
    "bathShelfHanger.type": "Вішалка з полицею",
    "bathShelfHanger.desc": "Образ: банний акцент з авторським сюжетом, теплою фактурою дерева і чорним патинованим металом. Матеріали: метал, брашована і полірована сосна, декоративна композиція з нержавіючої сталі. Розмір і деталі: вішалка з полицею для лазні або сауни.",
    "cosmicCatHanger.type": "Міні-вішалка",
    "cosmicCatHanger.desc": "Образ: міні-вішалка з космічною кішкою та мерехтливим ефектом галактики. Матеріали: металева основа, багатошарова епоксидна смола і латунні декоративні деталі. Розмір і деталі: близько 20 см, ручна робота, кожен рисунок заливки унікальний.",
    "acaciaPanel.type": "Wall panel",
    ...
    "roundHuntPanel.type": "Wall panel",
    "roundHuntPanel.desc": "Образ: сцена полювання на качку з лабрадором у теплій деревній фактурі та прозорій глибині смоли. Матеріали: акація, латунь, нержавіюча сталь і епоксидна смола. Розмір і деталі: кругле панно, діаметр 19 см.",
    "nook.type": "Wall piece",
  ...
  en: {
    ...
    "slateKennel.type": "Decorative plaque",
    "slateKennel.desc": "Image: an interior version of a kennel logo with deep black slate and the cool sheen of steel. Materials: natural black slate and brushed stainless steel. Size and details: 30 x 20 cm, wall-mounted or tabletop placement.",
    "silverLabradorClock.type": "Clock",
    "silverLabradorClock.desc": "Image: a Labrador and butterfly create a calm cool accent for a kitchen, office, or modern interior. Materials: silver acrylic on a dark dial with a glass front. Size and details: 27 cm diameter, wall-mounted.",
    "forgedLabradorBracket.type": "Bracket",
    "forgedLabradorBracket.desc": "Image: an expressive facade accent with a Labrador silhouette, hanging sign, and decorative console. Materials: metal, profile tube, and a forged decorative element. Size and details: 50 cm bracket, 2 mm metal, 15 mm profile tube.",
    "ringNumberHolder.type": "Ring number holder",
    "ringNumberHolder.desc": "Image: a light show accessory with a dog silhouette and lively glitter shine. Materials: epoxy resin, decorative wire, and a metal number clip. Size and details: handmade, each piece has a unique resin pattern.",
    "goldRingNumberHolder.type": "Ring number holder",
    "goldRingNumberHolder.desc": "Image: a ring accessory with an expressive contour, golden shine, and clear resin depth. Materials: decorative wire, glitter, gold leaf, and epoxy resin. Size and details: handmade, with individual shape and resin pattern.",
    "monoBreedAwards.type": "Awards",
    "monoBreedAwards.desc": "Image: a series of dog show awards with dog silhouettes, birds, and BOB, BOS, WB, and WD titles. Materials: polished olive wood, stainless steel, and brass with contrasting finishes. Size and details: 2 mm steel, 2 mm brass, from EUR 75 each or from EUR 250 for a set of 4.",
    "labradorExpertPlates.type": "Awards",
    "labradorExpertPlates.desc": "Image: expert awards for a mono-breed Labrador show with personalized BOB, BOS, and Best Junior titles. Materials: decorative plates with anodized finish and a transparent stand. Size and details: 27 cm plate diameter, chrome-effect coating.",
    "huskySlateAward.type": "Wall award",
    "huskySlateAward.desc": "Image: an interior award with a husky portrait, northern motifs, and a personal inscription on the reverse. Materials: natural black slate and stainless steel. Size and details: 30 cm diameter, 2 mm steel, double-sided engraving, 2-3 week production time.",
    "goldenRetrieverClock.type": "Clock",
    "goldenRetrieverClock.desc": "Image: a golden retriever watching a butterfly creates a warm accent for a calm interior. Materials: gold acrylic on a dark dial with a glass front. Size and details: 27 cm diameter wall clock.",
    "goldClock.type": "Clock",
    "goldClock.desc": "Image: a Labrador puppy on a dark dial adds a soft golden accent to the interior. Materials: gold acrylic and glass front. Size and details: 27 cm diameter wall clock.",
    "addressPlate.type": "Address sign",
    "addressPlate.desc": "Image: an address sign with a Labrador silhouette, decorative foliage, and house number in warm chocolate patina. Materials: powder-coated metal with hand patination. Size and details: 2 mm metal, facade placement.",
    "blackChocolateSign.type": "Backlit kennel sign",
    "blackChocolateSign.desc": "Image: a kennel facade sign where the name, Labrador silhouettes, and warm contour lighting work as one mark. Materials: metal, powder coating, and LED lighting. Size and details: 2 mm metal, warm back LED lighting, 1 x 1.7 m.",
    "bellaMarePanel.type": "Kennel gift panel",
    "bellaMarePanel.desc": "Image: a gift panel for the Bella Mare kennel with a clean interior composition and soft pearlescent glow. Materials: ash wood, stainless steel, glitter, and clear epoxy resin. Size and details: 50 x 30 cm, ash base, stainless-steel decor.",
    "panel.type": "Wall panel",
    "panel.desc": "Image: a compact vertical accent with a dog, reeds, and flying bird for a living room, hallway, or study. Materials: warm wooden base and black decorative silhouette. Size and details: decorative wall panel, 17 x 42 cm.",
    "bracket.type": "Kennel sign",
    "bracket.desc": "Image: an entrance accent with a Russian Borzoi silhouette and Radiance Soul hanging sign in warm bronze patina. Materials: powder-coated metal with hand patination. Size and details: bracket with decorative console, 2 mm metal.",
    "box.type": "Gift set",
    "box.desc": "Image: an intimate gift set for a home or study with two engraved glasses inside a wooden box. Materials: plywood, laser engraving, and antique brass-style hardware. Size and details: box made from 6 mm plywood.",
    "birchHuntingMoneyBox.type": "Money box",
    "birchHuntingMoneyBox.desc": "Image: a money box with a Labrador hunting scene, deep noble tone, and refined gift character. Materials: natural birch, laser engraving, and antique bronze-style lock. Size and details: 190 x 105 x 65 mm, for banknotes and jewelry.",
    "keyholder.type": "Key holder shelf",
    "keyholder.desc": "Image: a hunter-and-dog silhouette warms the entryway and gives the object character. Materials: wooden shelf, black decorative side panels, and metal hooks. Size and details: 25 cm key holder for keys, leashes, and a shoehorn.",
    "leashShelf.type": "Leash shelf",
    "leashShelf.desc": "Image: a neat entryway accent with dog silhouettes, hooks, and leash storage. Materials: polished and brushed pine, black decor, and oil-wax finish. Size and details: 27 cm key and leash shelf.",
    "bathShelfHanger.type": "Shelf hanger",
    "bathShelfHanger.desc": "Image: a sauna accent with an original scene, warm wood texture, and black patinated metal. Materials: metal, brushed and polished pine, and stainless-steel decorative composition. Size and details: shelf hanger for a bath or sauna.",
    "cosmicCatHanger.type": "Mini hanger",
    "cosmicCatHanger.desc": "Image: a mini hanger with a cosmic cat and glittering galaxy effect. Materials: metal base, layered epoxy resin, and brass decorative details. Size and details: approx. 20 cm, handmade, each resin pattern is unique.",
    "acaciaPanel.type": "Wall panel",
    ...
    "roundHuntPanel.type": "Wall panel",
    "roundHuntPanel.desc": "Image: a duck hunting scene with a Labrador in warm wood grain and clear resin depth. Materials: acacia, brass, stainless steel, and epoxy resin. Size and details: round wall panel, 19 cm diameter.",
    "nook.type": "Wall piece",
